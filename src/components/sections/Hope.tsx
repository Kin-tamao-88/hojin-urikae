      ...
      <div className="container-lp flex flex-col items-center">
        ...
        <div className="flex items-center justify-center gap-5 md:gap-6 md:-translate-x-5">
          ...
          <div className="text-center md:text-left">
            {/* ② */}
            <p className="text-[16px] font-extrabold tracking-wide text-navy md:text-[18px]">
              こんなお悩みありませんか？
            </p>
            ...
            <div className="relative mt-2 inline-block md:mt-3">
              <svg
                className="pointer-events-none absolute -bottom-4 left-[-10px] -z-0 h-[28px] w-[calc(100%+20px)] md:-bottom-2"
                viewBox="0 0 420 44"
                fill="none"
              ...
              <span className="relative font-black leading-none text-cta text-[clamp(42px,13vw,64px)] md:text-[86px]">
                現金化できる
              </span>
            </div>

            {/* ④ */}
            <p className="mt-2 font-extrabold leading-tight text-navy md:mt-3 md:text-[52px]" style={{ fontSize: "clamp(28px, 8vw, 38px)" }}>
              可能性があります！
            </p>
          </div>
        </div>
